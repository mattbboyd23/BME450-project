"""
train_llr_model_v2_1.py

Training script for v2.1 full UNet model.
Trains on normalized landmark outputs (0–1) using contrast-enhanced X-ray images.
"""

from llr_dataset import LLRDataset
from llr_cnn_model_v2_1 import LLRLandmarkCNNv2_1
...
model_save_path = os.path.join(base_path, 'v2_1', 'llr_model_v2_1.pth')
...
def normalize_coords(coords):
    coords = coords.clone()
    coords[::2] /= IMAGE_WIDTH   # x-coordinates
    coords[1::2] /= IMAGE_HEIGHT # y-coordinates
    return coords
...
model = LLRLandmarkCNNv2_1().to(device)
...
for epoch in range(NUM_EPOCHS):
    ...
    with torch.no_grad():
        for images, targets in val_loader:
            ...
            # Rescale for group MSE analysis
