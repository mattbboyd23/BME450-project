"""
train_llr_model_v2_1_light.py

Training script for v2.1 light model.
Uses smaller images and lighter UNet for faster training.
"""

from llr_dataset import LLRDataset
from llr_cnn_model_v2_1_light import LLRLandmarkCNNv2_1_Light
...
model_save_path = os.path.join(base_path, 'v2_1', 'llr_model_v2_1_light.pth')
...
model = LLRLandmarkCNNv2_1_Light().to(device)
