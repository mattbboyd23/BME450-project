"""
train_llr_model_v2_1_safe_augmented.py

Training script for v2.1 SAFE model with:
- Data augmentation
- Lower learning rate
...
model_save_path = os.path.join(base_path, 'v2_1', 'llr_model_v2_1_safe_augmented.pth')
